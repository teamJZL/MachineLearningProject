...
public class test4 {
	...
	public static void main(String[] args) throws Exception {
		 BufferedReader reader = new BufferedReader(new FileReader("C:/Users/Vineet/wekafiles/dataout/balance-scale_train.arff"));
		 ArffReader arff = new ArffReader(reader);
		 Instances isTrainingSet = arff.getData();
		 isTrainingSet.setClassIndex(isTrainingSet.numAttributes() - 1);
		 
		 
		 BufferedReader reader2 = new BufferedReader(new FileReader("C:/Users/Vineet/wekafiles/dataout/balance-scale_test.arff"));
   	...
   	// setup classifier 2
	    ...
	    // Print out the confusion matrix (from ianma.wordpress.com)
   	    ...
   	    op[0] = "-M";
   	 	Classifier ps3 = (Classifier)new Dagging(); 
   	    ps3.setOptions(op);
