...
public class ClassifierDagging {

    public static void main(String[] args) throws Exception {
        BufferedReader reader = new BufferedReader(new FileReader("data/autos_train.arff"));
        ...
        /*ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("anneal_dagging.model"));
        oos.writeObject(cModel);
        oos.flush();
        oos.close(); */

        BufferedReader reader2 = new BufferedReader(new FileReader("data/autos_test.arff"));
