...
public class ftparam {
    ...
    public static void main(String[] args) throws Exception {
        BufferedReader reader = new BufferedReader(new FileReader("ms4data/hypothyroid2_train.arff"));
        ...
        BufferedReader reader2 = new BufferedReader(new FileReader("ms4data/hypothyroid2_test.arff"));
